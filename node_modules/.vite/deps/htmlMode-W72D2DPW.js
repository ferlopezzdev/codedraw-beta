...
import {
  ...
  editor,
  languages
} from "./chunk-M6ZL6PO4.js";
import "./chunk-MMV5VDKF.js";
  ...
  function() {
    ...
    HTMLCompletion2.prototype._doComplete = function(document, position, htmlDocument, settings) {
      ...
      function collectCharacterEntityProposals() {
        ...
        if (k >= 0 && text[k] === "&") {
          var range = Range2.create(Position.create(position.line, characterStart - 1), position);
    ...
    HTMLHover2.prototype.doHover = function(document, position, htmlDocument, options) {
      ...
      function getEntityRange() {
        ...
        if (k >= 0 && text[k] === "&") {
          var range = null;
          if (text[n] === ";") {
            range = Range2.create(Position.create(position.line, characterStart), Position.create(position.line, characterEnd + 1));
          } else {
            range = Range2.create(Position.create(position.line, characterStart), Position.create(position.line, characterEnd));
          }
          return range;
        }
        return null;
  ...
  var t = { 470: (t2) => {
    ...
    var n = { resolve: function() {
      ...
      for (var s = r3.length - h, f = a < s ? a : s, u = -1, c = 0; c <= f; ++c) {
        if (c === f) {
          if (s > f) {
            if (47 === r3.charCodeAt(h + c))
              return r3.slice(h + c + 1);
            if (0 === c)
              return r3.slice(h + c);
          } else
            a > f && (47 === t3.charCodeAt(o + c) ? u = c : 0 === c && (u = 0));
          break;
        }
      ...
      var p = "";
      for (c = o + u + 1; c <= i; ++c)
        c !== i && 47 !== t3.charCodeAt(c) || (0 === p.length ? p += ".." : p += "/..");
      return p.length > 0 ? p + r3.slice(h + u) : (h += u, 47 === r3.charCodeAt(h) && ++h, r3.slice(h));
      ...
      if (void 0 !== r3 && r3.length > 0 && r3.length <= t3.length) {
        ...
        for (n2 = t3.length - 1; n2 >= 0; --n2) {
          ...
          if (47 === f) {
            ...
            -1 === s && (a = false, s = n2 + 1), h >= 0 && (f === r3.charCodeAt(h) ? -1 == --h && (i = n2) : (h = -1, i = s));
        }
      ...
      for (var a = -1, h = 0, s = -1, f = true, u = t3.length - 1, c = 0; u >= n2; --u)
        if (47 !== (o = t3.charCodeAt(u)))
          -1 === s && (f = false, s = u + 1), 46 === o ? -1 === a ? a = u : 1 !== c && (c = 1) : -1 !== a && (c = -1);
        else if (!f) {
          h = u + 1;
          break;
        }
      return -1 === a || -1 === s || 0 === c || 1 === c && a === s - 1 && a === h + 1 ? -1 !== s && (r3.base = r3.name = 0 === h && i ? t3.slice(1, s) : t3.slice(h, s)) : (0 === h && i ? (r3.name = t3.slice(1, a), r3.base = t3.slice(1, s)) : (r3.name = t3.slice(h, a), r3.base = t3.slice(h, s)), r3.ext = t3.slice(a, s)), h > 0 ? r3.dir = t3.slice(0, h - 1) : i && (r3.dir = "/"), r3;
    }, sep: "/", delimiter: ":", win32: null, posix: null };
    n.posix = n, t2.exports = n;
  }, 447: (t2, e2, r2) => {
    var n;
    if (r2.r(e2), r2.d(e2, { URI: () => g, Utils: () => O }), "object" == typeof process)
    ...
    var i, a, h = (i = function(t3, e3) {
      ...
      function t3(t4, e3, r3, n2, o2, i2) {
        void 0 === i2 && (i2 = false), "object" == typeof t4 ? (this.scheme = t4.scheme || c, this.authority = t4.authority || c, this.path = t4.path || c, this.query = t4.query || c, this.fragment = t4.fragment || c) : (this.scheme = function(t5, e4) {
      ...
      return t3.isUri = function(e3) {
        ...
        return void 0 === e3 ? e3 = this.scheme : null === e3 && (e3 = c), void 0 === r3 ? r3 = this.authority : null === r3 && (r3 = c), void 0 === n2 ? n2 = this.path : null === n2 && (n2 = c), void 0 === o2 ? o2 = this.query : null === o2 && (o2 = c), void 0 === i2 ? i2 = this.fragment : null === i2 && (i2 = c), e3 === this.scheme && r3 === this.authority && n2 === this.path && o2 === this.query && i2 === this.fragment ? this : new v(e3, r3, n2, o2, i2);
    ...
    function C(t3, e3) {
      var r3;
      return r3 = t3.authority && t3.path.length > 1 && "file" === t3.scheme ? "//" + t3.authority + t3.path : 47 === t3.path.charCodeAt(0) && (t3.path.charCodeAt(1) >= 65 && t3.path.charCodeAt(1) <= 90 || t3.path.charCodeAt(1) >= 97 && t3.path.charCodeAt(1) <= 122) && 58 === t3.path.charCodeAt(2) ? e3 ? t3.path.substr(1) : t3.path[1].toLowerCase() + t3.path.substr(2) : t3.path, n && (r3 = r3.replace(/\//g, "\\")), r3;
    }
    function A(t3, e3) {
      ...
      if (o2 && (n2 += o2, n2 += ":"), (i2 || "file" === o2) && (n2 += l, n2 += l), i2) {
        ...
        if (-1 !== f2) {
          ...
          i2 = i2.substr(f2 + 1), -1 === (f2 = u2.indexOf(":")) ? n2 += r3(u2, false) : (n2 += r3(u2.substr(0, f2), false), n2 += ":", n2 += r3(u2.substr(f2 + 1), false)), n2 += "@";
        }
        -1 === (f2 = (i2 = i2.toLowerCase()).indexOf(":")) ? n2 += r3(i2, false) : (n2 += r3(i2.substr(0, f2), false), n2 += i2.substr(f2));
      }
      if (a2) {
...
//# sourceMappingURL=htmlMode-W72D2DPW.js.map
