    ...
    var n = { resolve: function() {
      ...
      for (var s = r3.length - h, f2 = a2 < s ? a2 : s, u = -1, c = 0; c <= f2; ++c) {
        if (c === f2) {
          if (s > f2) {
            ...
            a2 > f2 && (47 === t3.charCodeAt(o + c) ? u = c : 0 === c && (u = 0));
          break;
        }
      ...
      if (void 0 !== r3 && r3.length > 0 && r3.length <= t3.length) {
        ...
        for (n2 = t3.length - 1; n2 >= 0; --n2) {
          ...
          if (47 === f2) {
            ...
            -1 === s && (a2 = false, s = n2 + 1), h >= 0 && (f2 === r3.charCodeAt(h) ? -1 == --h && (i = n2) : (h = -1, i = s));
        }
      ...
      for (var a2 = -1, h = 0, s = -1, f2 = true, u = t3.length - 1, c = 0; u >= n2; --u)
        if (47 !== (o = t3.charCodeAt(u)))
          -1 === s && (f2 = false, s = u + 1), 46 === o ? -1 === a2 ? a2 = u : 1 !== c && (c = 1) : -1 !== a2 && (c = -1);
        else if (!f2) {
          h = u + 1;
          break;
        }
      return -1 === a2 || -1 === s || 0 === c || 1 === c && a2 === s - 1 && a2 === h + 1 ? -1 !== s && (r3.base = r3.name = 0 === h && i ? t3.slice(1, s) : t3.slice(h, s)) : (0 === h && i ? (r3.name = t3.slice(1, a2), r3.base = t3.slice(1, s)) : (r3.name = t3.slice(h, a2), r3.base = t3.slice(h, s)), r3.ext = t3.slice(a2, s)), h > 0 ? r3.dir = t3.slice(0, h - 1) : i && (r3.dir = "/"), r3;
    ...
    function A2(t3, e3) {
      ...
      if (o2 && (n2 += o2, n2 += ":"), (i2 || "file" === o2) && (n2 += l, n2 += l), i2) {
        ...
        if (-1 !== f3) {
          ...
          i2 = i2.substr(f3 + 1), -1 === (f3 = u2.indexOf(":")) ? n2 += r3(u2, false) : (n2 += r3(u2.substr(0, f3), false), n2 += ":", n2 += r3(u2.substr(f3 + 1), false)), n2 += "@";
        }
        -1 === (f3 = (i2 = i2.toLowerCase()).indexOf(":")) ? n2 += r3(i2, false) : (n2 += r3(i2.substr(0, f3), false), n2 += i2.substr(f3));
      }
      if (a3) {
...
var ParentsStack = (
  ...
  function() {
    ...
    ParentsStack2.equals = function(a2, b) {
      if (!a2 && !b) {
        return true;
      }
      if (!a2 || !b) {
...
//# sourceMappingURL=jsonMode-6LGAVHST.js.map
